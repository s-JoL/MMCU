...
import torch
from transformers import OpenLlamaForCausalLM, OpenLlamaConfig, LlamaTokenizer, GenerationConfig
...
ckpt = torch.load(
    "data/saved_ckpt/7B_instruct/pytorch_model/mp_rank_00_model_states.pt",
    map_location="cpu",
)
if "module" in ckpt:
    ckpt = ckpt["module"]
